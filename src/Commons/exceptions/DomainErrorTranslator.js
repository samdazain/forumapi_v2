...
DomainErrorTranslator._directories = {
  ...
  'DELETE_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION':
    new InvariantError('refresh token harus string'),
  'ADD_THREAD.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError(
  ...
  'ADD_COMMENT.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError(
    'Missing authentication',
  ),
  ...
  'DELETE_COMMENT.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError(
    'Missing authentication',
  ),
  'DELETE_COMMENT_USE_CASE.NOT_CONTAIN_OWNER': new AuthenticationError(
    'Missing authentication',
  ),
  ...
  'LIKE_COMMENT_USE_CASE.NOT_CONTAIN_OWNER': new AuthenticationError(
    'Missing authentication',
  ),
  'ADD_REPLY.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError(
    'Missing authentication',
  ),
  ...
  'DELETE_REPLY_USE_CASE.NOT_CONTAIN_OWNER': new AuthenticationError(
    'Missing authentication',
  ),
  'DELETE_REPLY.NOT_MEET_AUTHENTICATION_DATA': new AuthenticationError(
    'Missing authentication',
  ),
