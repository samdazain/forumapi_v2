...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('ADD_THREAD.NOT_MEET_AUTHENTICATION_DATA'),
      ),
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('ADD_COMMENT.NOT_MEET_AUTHENTICATION_DATA'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(
      DomainErrorTranslator.translate(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('DELETE_COMMENT.NOT_MEET_AUTHENTICATION_DATA'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(
      DomainErrorTranslator.translate(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('ADD_REPLY.NOT_MEET_AUTHENTICATION_DATA'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(
      DomainErrorTranslator.translate(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('DELETE_REPLY_USE_CASE.NOT_CONTAIN_OWNER'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(
      DomainErrorTranslator.translate(
        new Error('DELETE_REPLY.NOT_MEET_AUTHENTICATION_DATA'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
    expect(
      DomainErrorTranslator.translate(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('LIKE_COMMENT_USE_CASE.NOT_CONTAIN_OWNER'),
      ),
    ).toStrictEqual(new AuthenticationError('Missing authentication'));
  });
